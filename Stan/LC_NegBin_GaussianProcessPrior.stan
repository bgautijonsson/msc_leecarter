...
transformed parameters {
  vector[N_groups - 1] beta_unconstrained = gp_to_pars(mu_beta, sigma_beta, ages[1:(N_groups - 1)], eta_beta, rho_beta, z_beta, N_groups - 1);
  vector[N_groups] beta = simplex_transform(beta_unconstrained, N_groups);
  vector[N_groups] alpha = gp_to_pars(mu_alpha, sigma_alpha, ages, eta_alpha, rho_alpha, z_alpha, N_groups);
